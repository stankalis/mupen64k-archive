...
DEFAULT_ROM_SETTINGS GetDefaultRomSettings(char *Section) 
{
    ...
    GetPrivateProfileString( Section, "Cheat",    "", DefaultRomSettings.CheatPluginName,  100, RomSettingsFilePath());
...
void saveDefaultRomSettings(char *Section, DEFAULT_ROM_SETTINGS DefaultRomSettings)
{
    ...
    WritePrivateProfileString( Section, "Cheat",     DefaultRomSettings.CheatPluginName,    RomSettingsFilePath());
}
