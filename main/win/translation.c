...
void TranslateMenu(HMENU hMenu,HWND mainHWND)
{
    ...
    SetMenuTranslatedString(submenu,6,"Gameshark","");
    
    SetMenuTranslatedString(submenu,8 ,"Show Toolbar","Alt+T");
    SetMenuTranslatedString(submenu,9 ,"Show Statusbar","Alt+S");
    SetMenuTranslatedString(submenu,11 ,"Settings...","Ctrl+S");
    ...
    SetMenuTranslatedString(submenu,6,"SupraClient (NetPlay)","");
    SetMenuTranslatedString(submenu,7,"KailleraClient (NetPlay)","");
    SetMenuTranslatedString(submenu,9,"Record","");
    ...
    SetMenuTranslatedString(submenu,0,"Help!","");
    SetMenuTranslatedString(submenu,1,"What's new?","");
    SetMenuTranslatedString(submenu,3,"About Mupen64++","");
